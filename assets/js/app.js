...
const playlist = [
  "/assets/audio/satranga.mp3",
  "/assets/audio/chaleya.mp3",
  "/assets/audio/4.10.mp3",
  "/assets/audio/kesariya.mp3",
  "/assets/audio/wohRaat.mp3",
  "/assets/audio/thodaThodaPyaar.mp3",
  "/assets/audio/malang.mp3",
  "/assets/audio/Duniyaa.mp3",
  "/assets/audio/labonKo.mp3",
  "/assets/audio/lovely.mp3",
  "/assets/audio/stay.mp3",
  "/assets/audio/jannateinKahan.mp3",
  "/assets/audio/sometimes.mp3",
  "/assets/audio/seedheMaut.mp3",
  "/assets/audio/tuHaiKahan.mp3",
  "/assets/audio/arjanVailly.mp3",
  "/assets/audio/ranjha.mp3",
  "/assets/audio/ratanLambiyan.mp3",
  "/assets/audio/manjha.mp3",
  "/assets/audio/chaleya.mp3",
  "/assets/audio/satranga.mp3",
  "/assets/audio/phirMohobbat.mp3",
  "/assets/audio/hothonSeChulo.mp3",
  "/assets/audio/noMercy.mp3",
  "/assets/audio/blowingUp.mp3",
  "/assets/audio/prarthna.mp3",
  "/assets/audio/athmaRama.mp3",
  "/assets/audio/ben10.mp3",
  "/assets/audio/Despacito.mp3",
  "/assets/audio/AapaferMilage.mp3",
  "/assets/audio/LetMeDownSlowly.mp3  ",
  "/assets/audio/thar.mp3",
  "/assets/audio/Weapon.mp3",
  "/assets/audio/Husn.mp3",
  "/assets/audio/nightchanges.mp3",
];
...
const songDetails = [
  ...
  {
    src: "/assets/song-img/despacito.jpg",
    name: "Despacito",
    description: "Luis Fonsi, Daddy Yankee, justin bieber",
    fullName: "Despacito",
  },
  {
    src: "/assets/song-img/AapaferMilage.jpg",
    name: "Aapa fer Mila ge",
    description: "Savi kahlon",
    fullName: "Aapa fer Mila ge",
  },
  {
    src: "/assets/song-img/LetMeDownSlowly.jpg",
    name: "Let Me Down Slowly",
    description: "Alec Benjamin",
    fullName: "Let Me Down Slowly",
  },
  {
    src: "/assets/song-img/thar.jpg",
    name: "thar",
    description: "Jassi Kirarkot , Komal Choudhary, love kataria, khushi baliyan",
    fullName: "thar",
  },
  {
    src: "/assets/song-img/Weapon.jpg",
    name: "Weapon",
    description: "KD DESIROCK, Komal Choudhary",
    fullName: "Weapon",
  },
  {
    src: "/assets/song-img/husn.jpg",
    name: "Husn",
    description: "Anuv Jain",
    fullName: "Husn",
  },
  {
    src: "/assets/song-img/nightchanges.jpg",
    name: "Night Changes",
    description: "One Dirsction",
    fullName: "Night Changes",
  },
];
